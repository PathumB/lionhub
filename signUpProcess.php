...
if(empty($fname)){
    ...
    echo "Password length should be between 5 and 20";
    ...
    if($r->num_rows > 0){
        echo "User with the same email and mobile already registered";
    }else{
        $d = new DateTime();
        ...
        Database::iud("INSERT INTO user (`email`,`fname`,`lname`,`password`,`mobile`,`register_date`,`gender_id`,`status_id`) VALUES('".$email."','".$fname."','".$lname."','".$password."','".$mobile."','".$date."','".$gender."','".$sellerd."');");
        echo "1";
    }
